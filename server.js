...
client.on('ready', async () => {
    ...
    connection.voice.setSelfDeaf(false)
        ...
        .setColor("#1b00ff")
        .setTitle("checking bot =>")       
  
        client.channels.cache.get("836501877650751518").send(ed)
                        let eda = new Discord.MessageEmbed()
        .setColor("#1b00ff")
        .setTitle("autoraizing =>")
        client.channels.cache.get("836501877650751518").send(ed)
                          let aeda = new Discord.MessageEmbed()
        .setColor("#1b00ff")
        .setTitle("bot ready")
        client.channels.cache.get("836501877650751518").send(aeda)
  });
